...
import {instance,imagenes_id,encounterTypeFinalizada_id,observacionesFotoURL,CLOUDINARY_UPLOAD_URL,CLOUDINARY_UPLOAD_PRESET} from '../../../axios-orders';
...
export default class finalizarImagenes extends React.Component {
    constructor(...args){
        super(...args);
        this.state={
            date: moment(),
            ...
            .then(
                (res) => {
                    var detalles={
                        ...
                        "concept": this.state.orden.imagenes.value,
